...
class GameListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'review_count', 'cover_image', 'heat_total', 'release_date',
            'is_collected'
        ]
        read_only_fields = ['id', 'heat_total', 'is_collected']
...
class GameDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'is_collected', 'created_at', 'updated_at'
        ]
        read_only_fields = [
...
class GameCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Game
        fields = [
            'name', 'category', 'publisher', 'tag_ids',
